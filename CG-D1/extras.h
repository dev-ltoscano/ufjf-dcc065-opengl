...
void initLight(int windowWidth, int windowHeight)
{
   ...
   GLfloat posicao_luz[] = { (float) windowWidth, (float)windowHeight, 1000.0, 1.0};
...
void setMaterials(void)
{
    ...
    GLfloat objeto_ambient_front[] = { 0.1745, 0.174, 0.011, 1.0 };
    GLfloat objeto_difusa_front[] = { 0.6144, 0.614, 0.041, 1.0 };

    glMaterialfv(GL_FRONT, GL_AMBIENT, objeto_ambient_front);
    glMaterialfv(GL_FRONT, GL_DIFFUSE, objeto_difusa_front);
    glMaterialfv(GL_FRONT, GL_SPECULAR, objeto_especular);
    glMaterialfv(GL_FRONT, GL_SHININESS, objeto_brilho);

    // Material das faces internas
